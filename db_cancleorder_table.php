...
// sql to create table
$sql_created_table = "CREATE TABLE if not exists food_world_database.cancleorder_table(
...
// $result_table = mysqli_query($conn,$sql_created_table);
...
if (mysqli_query($conn, $sql_created_table)) {
  echo 'Yes Your Cancle Table Created Successfully NOW!';
} else {
